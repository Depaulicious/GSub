...
class Player(GObject.GObject):
    ...
    def _start_plugin_installation(self, missing_plugin_messages, confirm_search):
        ...
        if self._gst_plugins_base_check_version(1, 5, 0):
            install_ctx.set_desktop_id('eu.depau.GSub.desktop')
    ...
    def _setup_view(self):
        ...
        self._ui.add_from_resource('/eu/depau/GSub/PlayerToolbar.ui')
...
class SelectionToolbar():
    ...
    def __init__(self):
        self._ui = Gtk.Builder()
        self._ui.add_from_resource('/eu/depau/GSub/SelectionToolbar.ui')
        self.actionbar = self._ui.get_object('actionbar')
