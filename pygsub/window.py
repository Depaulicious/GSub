...
from pygsub import TrackerWrapper
from pygsub.toolbar import Toolbar, ToolbarState
from pygsub.player import Player, SelectionToolbar, RepeatType
from pygsub.query import Query
from pygsub.views.albumsview import AlbumsView
from pygsub.views.artistsview import ArtistsView
from pygsub.views.emptyview import EmptyView
from pygsub.views.emptysearchview import EmptySearchView
from pygsub.views.initialstateview import InitialStateView
from pygsub.views.searchview import SearchView
from pygsub.views.songsview import SongsView
from pygsub.views.playlistview import PlaylistView
from pygsub.widgets.playlistdialog import PlaylistDialog
from pygsub.playlists import Playlists
...
class Window(Gtk.ApplicationWindow):
    ...
    def __init__(self, app):
        ...
        self.settings = Gio.Settings.new('eu.depau.GSub')
